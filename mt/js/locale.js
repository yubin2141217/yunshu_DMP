window.ArcoProLocale = {
  login: {
    pageTitle: '登录',
    title: '账号登录',
    subTitle: '维护供数方、元数据与接入方案，为机构配置可接收范围并发布接入标准',
    userNameErr: '用户名不能为空',
    passwordErr: '密码不能为空',
    ...
    userNamePh: '请输入登录账号',
    passwordPh: '请输入登录密码',
    demoAccount: '演示账号：yunying / 123456',
    remember: '记住密码',
    forget: '忘记密码',
    loginBtn: '登录',
    register: '注册账号',
  ...
  menu: {
    'menu.suppliers': '供数方管理',
    'menu.orgConfig': '机构供数配置',
    'menu.metadata': '字段库管理',
    'menu.scheme': '接入方案',
    'menu.standard': '接入方案管理',
    'menu.standard.list': '接入方案管理',
    'menu.dashboard': '数据看板',
