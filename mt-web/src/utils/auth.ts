export const DEMO_USER = import.meta.env.VITE_DEMO_USER || 'yunying'
export const DEMO_PASS = import.meta.env.VITE_DEMO_PASS || '123456'

const PARAMS_KEY = 'yunshu-mt-login-params'
