  ...
  window.ProShellNavbarActions = {
    ...
    template: `
      <ul class="pro-navbar-right">
        ...
        <li class="pro-navbar-item v8-chrome-hide">
        ...
        <li v-if="!isNarrow" class="pro-navbar-item v8-chrome-hide">
        ...
        <li class="pro-navbar-item pro-navbar-item--user">
          <a-dropdown :trigger="['hover', 'click']" position="br" content-class="pro-user-dropdown">
            <span class="pro-navbar-user" :aria-label="userInfo.name">
              ...
              <span class="v8-navbar-user-name">{{ userInfo.name }}</span>
            </span>
            <template #content>
    ...
    >
      ...
      >
        <header v-if="showNavbar && (layoutMode === 'top' || isNarrow)" class="pro-navbar pro-navbar--global">
          <div class="v8-chrome-top">
            <div class="v8-chrome-brand">
          ...
          <div v-if="!isNarrow" class="v8-chrome-nav">
            <nav class="v8-top-nav" aria-label="主导航">
              <a-menu
                class="v8-top-menu"
                mode="horizontal"
                :selected-keys="selectedKeys"
              ...
              >
                <a-menu-item v-for="item in menuRoutes" :key="item.key">{{ menuLabel(item.name) }}</a-menu-item>
              </a-menu>
            </nav>
          </div>
        </header>
