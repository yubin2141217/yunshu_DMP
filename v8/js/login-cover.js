;(function () {
  if (AdminAuth.isLoggedIn()) {
    window.location.href = (window.YunshuBrand && YunshuBrand.homeHref) || 'dashboard.html'
    return
  }
  ...
  document.title = t.pageTitle + ' - ' + ((window.YunshuBrand && YunshuBrand.appTitle) || 'Vibe Design Pro')
  ...
  createApp({
    data() {
      ...
      return {
        ...
        loading: false,
        t,
        brandLogo: (window.YunshuBrand && (YunshuBrand.appTitle || YunshuBrand.logoText)) || '云数中台',
        forgetVisible: false,
        ...
        <div class="login-content">
          <div class="login-form-wrapper login-form-card">
            <div class="login-logo">
              ...
              <span class="login-logo-text">{{ brandLogo }}</span>
            </div>
          ...
          <footer class="login-footer pro-footer">© 2026 云数中台</footer>
        </div>
